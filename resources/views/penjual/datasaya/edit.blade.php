                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sertifikat" id="sertifikat">
                                    ...
                                    <option value="HGB - Hak Guna Bangun"
                                        ...
                                        {{$data->sertifikat === 'HP - Hak Pakai' ? 'selected' : ''}}>HP - Hak Pakai</option>

                                    <option value="Belum Terdaftar"
                                        {{$data->sertifikat === 'Belum Terdaftar' ? 'selected' : ''}}>Belum Terdaftar</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="jenis_lahan" id="jenis_lahan">
                                    ...
                                    <option value="Lahan Kavling" {{ $data->jenis_lahan == 'Lahan Kavling' ? 'selected' : '' }} >Lahan Kavling
                                    </option>
                                    <option value="Lahan Pertanian"
                                    {{ $data->jenis_lahan == 'Lahan Pertanian' ? 'selected' : '' }} >Lahan Pertanian
                                    </option>
