                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('judul_lahan') }}" name="judul_lahan" id="judul_lahan"
                                        class="form-control @error('judul_lahan') is-invalid @enderror"
                                        placeholder="Masukan Judul Lahan">
                                </div>
                                @error('judul_lahan')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('luas_lahan') }}" name="luas_lahan"
                                        class="form-control  @error('luas_lahan') is-invalid @enderror" id="luas_lahan"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('harga_lahan') }}" name="harga_lahan" id="harga_lahan"
                                        class="form-control input-harga  @error('harga_lahan') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control  @error('sertifikat') is-invalid @enderror"
                                        ...
                                        <option value="HP - Hak Pakai"
                                            {{ old('sertifikat') === 'HP - Hak Pakai' ? 'selected' : '' }}>HP - Hak Pakai
                                        </option>

                                        <option value="Lainnya" {{ old('sertifikat') === 'Lainnya' ? 'selected' : '' }}>
                                            Lainnya
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control  @error('jenis_lahan') is-invalid @enderror"
                                        name="jenis_lahan" id="jenis_lahan">
                                        ...
                                        <option value="Lahan Pertanian"
                                            {{ old('jenis_lahan') === 'Lahan Pertanian' ? 'selected' : '' }}>Lahan
                                            Pertanian
                                        </option>
                                        <option value="Lahan Perkebunan"
                                            {{ old('jenis_lahan') === 'Lahan Perkebunan' ? 'selected' : '' }}>Lahan
                                            Perkebunan
                                        </option>
                                    </select>
                                </div>
...
@section('script')
    ...
    <script>
        ...
        $.each(kecamatanArray, function(key, item) {
            htmlKecamatan += `<option value="${item}" ${ '{!! old("kecamatan") !!}' === item ? 'selected' : ''}>${item}</option>`
        })
