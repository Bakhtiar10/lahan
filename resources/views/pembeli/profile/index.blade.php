...
@section('title') Profile Pembeli @endsection
@section("content")
        ...
        <div class="card">
            <div class="m-b-20">
                <div class="contact-grid">
                    ...
                    @else
                    <img src="{{ asset($pembeli->image) }}" class="user-img" alt="" height="130">
                    @endif
                    <div class="row">
                        <div class="col-4">
                            <h5>Nama</h5>
                            <small>{{$pembeli->name}}</small>
                        </div>
                        <div class="col-4">
                            <h5>Email</h5>
        ...
        <div class="tab-content">
            <div id="usersettings" aria-expanded="true">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="{{ route('pembeli.update_profile', $pembeli->id) }}" method="post">
                            @csrf
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Email"
                                    value="{{ $pembeli->email }}" name="email">
                            </div> -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="Number" class="form-control" placeholder="No Hp"
                                    value="{{ $pembeli->no_hp }}" name="no_hp">
                            </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="formModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{ route('pembeli.update_fotoprofile', $pembeli->id) }}" method="POST"
