...
<div class="limiter">
    <div class="container-login100 page-background">
        <div class="wrap-login100">
            ...
            @endif
            <form class="login100-form validate-form" method="POST" action="{{ route('pembeli.login') }}">
                @csrf
                ...
                <div class="text-center p-t-50">
                    Belum Punya Akun ?
                    <a class="txt1" href="{{ route('pembeli.register') }}">Register</a>
                </div>
                <!-- <div class="text-center p-t-50">
                    @if (Route::has('password.request'))
                    <a class="txt1" href="{{ route('pembeli.password.request') }}">
                        Forgot Password ?
                    </a>
                    @endif
                </div> -->
